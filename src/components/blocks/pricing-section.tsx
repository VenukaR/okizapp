...
function PricingSection({ tiers, className }: PricingSectionProps) {
  // Removed yearly state as there is only monthly plans
    ...
    >
      <div className="w-full max-w-5xl mx-auto">
        <div className="flex flex-col items-center gap-4 mb-12">
          ...
          <p className="text-zinc-600 dark:text-zinc-400 text-center max-w-2xl">
            Choose the plan that works best for your business. All plans include access to the OKIZ student network.
          </p>
        </div>
