      ...
      <div className="container relative z-10 mx-auto px-4 py-20 lg:py-32">
        <div className="flex flex-col items-center gap-16 lg:flex-row lg:gap-20">
          ...
          <div className="flex flex-col gap-8 lg:w-3/5">
            ...
            {/* Heading */}
            <h1 className="text-5xl font-bold text-gray-900 md:text-6xl lg:text-7xl xl:text-8xl leading-tight">
            ...
            <div className="flex flex-wrap items-center gap-4 lg:gap-6 pt-4">
              <a
                ...
                className="group inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl shadow-lg"
              >
                <svg 
              ...
              <a
                ...
                className="group inline-flex items-center justify-center px-8 py-4 bg-white text-blue-600 font-semibold rounded-xl border-2 border-blue-200 hover:bg-blue-50 hover:border-blue-300 transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-lg"
              >
            ...
            {/* Trust Indicators */}
            <div className="flex flex-wrap items-center gap-8 pt-8 text-sm text-gray-600">
          ...
          <div className="relative lg:w-2/5 flex justify-center">
            {/* Decorative Elements */}
            <div className="absolute inset-0 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full blur-3xl opacity-20 scale-150 animate-pulse"></div>
            
            {/* Phone Container */}
            <div className="relative z-10 transform hover:scale-105 transition-transform duration-500">
              {/* Glow Effect */}
              <div className="absolute -inset-4 bg-gradient-to-r from-blue-600 to-blue-400 rounded-[50px] opacity-20 blur-2xl"></div>
              ...
              <div className="relative">
                ...
                <div className="absolute -right-8 top-1/4 bg-white rounded-2xl shadow-2xl p-4 transform rotate-6 hover:rotate-0 transition-transform duration-300 border border-blue-100 hidden lg:block z-20">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-bold text-gray-800">Avg Savings</p>
