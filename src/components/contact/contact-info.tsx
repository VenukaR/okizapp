    ...
    <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-xl p-8 md:p-10">
      ...
      <div className="mt-12">
        ...
        <div className="flex space-x-4">
          <a href="#" className="bg-gray-100 dark:bg-gray-800 p-3 rounded-full hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-colors">
