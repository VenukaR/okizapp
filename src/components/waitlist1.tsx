...
const Waitlist1 = () => {
  return (
    <section className="flex h-full min-h-screen w-screen items-center justify-center overflow-hidden bg-white py-25 text-gray-900">
      <div className="container flex w-full flex-col items-center justify-center px-4 md:h-full">
        {/* Heading */}
        <h2 className="relative z-20 py-2 text-center font-sans text-5xl font-bold tracking-tight md:py-10 lg:text-7xl">
          Join the Waitlist
        </h2>
        ...
        <div className="relative z-20 mt-10 flex w-full max-w-md items-center gap-3 rounded-full border border-gray-200 bg-gray-50 p-2 shadow-sm">
          <Input
            className="h-12 w-full rounded-full border-none bg-transparent px-4 text-gray-900 placeholder-gray-400 focus-visible:ring-2 focus-visible:ring-blue-500"
            placeholder="Enter your email"
          />
          <Button className="h-12 rounded-full bg-blue-600 px-6 font-semibold text-white shadow-md hover:bg-blue-700">
            Join
          </Button>
        </div>
